...
*/
        ...
        let c_tr = document.createElementNS(svgNamespace, "circle");
        let c_bl = document.createElementNS(svgNamespace, "circle");
        let c_br = document.createElementNS(svgNamespace, "circle");

        ci.setAttributeNS(null, "cx", cx_);
        ci.setAttributeNS(null, "cy", cy_);
        ci.setAttributeNS(null, "r", "3");
        ci.setAttributeNS(null, "fill", "red");
        ...
        cc = c_tl;
        cc.setAttributeNS(null, "cx", x);
        cc.setAttributeNS(null, "cy", y);
        cc.setAttributeNS(null, "r", "3");
        cc.setAttributeNS(null, "fill", "blue");
        cc.setAttributeNS(null, "stroke", "black");
        cc.setAttributeNS(null, "strok-width", "2");
        node.parentNode.appendChild(cc);
        new JSYG(cc).setMtx(mtx);

        cc = c_tr;
        cc.setAttributeNS(null, "cx", x + w);
        cc.setAttributeNS(null, "cy", y);
        cc.setAttributeNS(null, "r", "3");
        cc.setAttributeNS(null, "fill", "blue");
        cc.setAttributeNS(null, "stroke", "black");
...
/*
        ...
        cp.setAttributeNS(null, "r", "3");
        cp.setAttributeNS(null, "fill", "blue");
        cp.setAttributeNS(null, "stroke", "black");
        cp.setAttributeNS(null, "strok-width", "2");
        g.appendChild(cp);
        //node.appendChild(g);
        node.parentNode.appendChild(g);
*/
        node.setAttributeNS(null, "fill", "lightgreen");
