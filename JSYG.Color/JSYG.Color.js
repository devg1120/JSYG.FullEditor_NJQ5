...
export   function Color(arg) {
    ...
    Color.prototype = {
        ...
        toString(format) {
            ...
            if (!format || format === 'rgb') { return `rgb(${this.r},${this.g},${this.b})`; }
                ...
                const codes = Color.htmlCodes;
                let rgb;

                for (const n in codes) {
     ...
     * @returns {String}
     */
    Color.rgb2hex = (r, g, b) => (0x1000000 | b | (g << 8) | (r << 16)).toString(16).slice(1);
